...
const readConfigFromContext = async (context: SmartAppContext): Promise<ContextSmartAppConfigValues> => ({
  ...
  tempDisableAllRules: getPrimitiveVarFromContextOrDefault(context, 'tempDisableAllRules', context.configBooleanValue.bind(context), false as boolean),
  tempDisableDaylightRule: getPrimitiveVarFromContextOrDefault(context, 'tempDisableDaylightRule', context.configBooleanValue.bind(context), false as boolean),
  tempDisableNightlightRule: getPrimitiveVarFromContextOrDefault(context, 'tempDisableNightlightRule', context.configBooleanValue.bind(context), false as boolean),
  tempDisableIdleRule: getPrimitiveVarFromContextOrDefault(context, 'tempDisableIdleRule', context.configBooleanValue.bind(context), false as boolean),
  tempDisableTransitionRule: getPrimitiveVarFromContextOrDefault(context, 'tempDisableTransitionRule', context.configBooleanValue.bind(context), false as boolean),
